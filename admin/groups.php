                    ...
                    <table>
                        <thead>
                            <tr class="table40-head">
                                <th class="column1">Group Name</th>
                                <th class="column2">Unique id</th>
                                <th class="column3">Teacher code</th>
                               <th class="column3">Student code</th>
...
$rs1 = mysqli_query($con,"select * from groups order by groupcode desc ");

while($row = mysqli_fetch_row($rs1)){
    echo"<tr>";
    echo"<td class=\"column1\">".$row[3]."</td>";
    echo"<td class=\"column2\">".$row[4]."</td>";
    echo"<td class=\"column3\">".$row[1]."</td>";
