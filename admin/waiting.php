...
$rs1 = mysqli_query($con,"select * from waiting_teacher");

while($row = mysqli_fetch_row($rs1)){
    echo"<tr>";
    $code = $row[0];
    echo"<td class=\"column1\">".$row[1]."</td>";
    echo"<td class=\"column2\">".$row[2]."</td>";
    echo"<td class=\"column3\">".$row[3]."</td>";
    echo"<td class=\"column3\"><a href=\"accept.php?id=$code\">accept</a></td>";
    echo"<td class=\"column3\"><a href=\"decline.php?id=$code\">decline</a></td>";
    echo"</tr>";
