                    ...
                    <table>
                        <thead>
                            <tr class="table40-head">
                               ...
                               <th class="column3">roll number</th>
                               <th class="column3"></th>
...
$rs1 = mysqli_query($con,"select * from student");

while($row = mysqli_fetch_row($rs1)){
    echo"<tr>";
    $code = $row[0];
    echo"<td class=\"column1\">".$row[2]."</td>";
    echo"<td class=\"column2\">".$row[3]."</td>";
    echo"<td class=\"column3\">".$row[5]."</td>";
    echo"<td class=\"column3\">".$row[1]."</td>";
    echo"<td class=\"column3\"><a href=\"deletestudent.php?id=$code\">delete</a></td>";
    echo"</tr>";
