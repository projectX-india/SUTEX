...
<div class="row justify-content-center">
    ...
    $query2="select * from ".$assignment_table." order by assignment_deadline";
    $rs2=mysqli_query($con,$query2)or die("cannot perform query2");
    ...
    echo"<h2 class=\"blog-head\" style=\"color: #2d2d2d;\">".$row[1]."</h2>";
        echo"<p> ".$row[2]."</p>";
        echo"<p>last submission date - ".$row[5]."</p>";
        if($row[3]!=""){
            $link = $row[3];
            echo"<p><a href=\"$link\" target=\"_blank\">attachment</a></p>";
        }
        echo"</p><a href=\"submitassignment.php?sid=$subjectid&aid=$asid\"><button class=\"button button-contactForm boxed-btn\">submit assignment</button></a></p>";
        echo" </div>
        </article>";
