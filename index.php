  ...
  <body>
      ...
      <div id="content" class="p-4 p-md-5">
                ...
                <div class="col-lg-6">
                    <div class="hero-text">
                        <h1>
                        	...
                        	complete learning and classroom solution for your institute!
                        <br><br><br>
                        <p>Made at HackGujarat by Team phoenix:
                          <br>
                          Team members- 
                          <br>
                          Parv Gupta
        ...
        <div class="hero-slider owl-carousel">
            <div class="hs-item set-bg" data-setbg="images/logo.jpg"></div>
