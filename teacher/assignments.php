...
$query5 = "select * from ".$assignment_table_name." order by assignment_createtime desc";
$rs6 = mysqli_query($con,$query5);

while($row = mysqli_fetch_row($rs6)){
    $assignment_id = $row[0];
    ...
    echo"<p><a href=\"submissions.php?id=$gid&sid=$sid&aid=$assignment_id\"><button class=\"button button-contactForm boxed-btn\">check submissions</button></a></p>";
    echo"<p><a href=\"deleteassignment.php?id=$gid&sid=$sid&aid=$assignment_id\"><button class=\"button button-contactForm boxed-btn\">delete assignment</button></a></p>";
    echo" </div>
    </article>";
