...
$rs6 = mysqli_query($con,"select * from groups where group_uniquename = '$gid_decrypted'");
$row = $rs6 ->fetch_assoc();
$studentjoincode = $row['scode'];
...
<html lang="en">
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
            ...
            <li class="active"><a href="teacher.php">Main menu</a></li>
            <li>
    ...
    ?>
                ...
                <li>
                  ...
                  echo"
                <a href=\"students.php?id=$gid\">Student List</a>";
...
?>
      ...
      <div id="content" class="p-4 p-md-5">
        ...
        <h1><center><?php echo $groupname; ?></center></h1>
<?php
        echo'Student join code - '.$studentjoincode."<br><br>";
?>
<!-- Courses area start -->
        ...
        $query1 = "select * from ".$tablename." where subject_teachercode = '$teacher_id'";
            ...
            <div class=\"properties properties2 mb-30\">
                <div class=\"properties__card\">
                    <div class=\"properties__img overlay1\">
                        <a href=\"classroom.php?id=$gid&sid=$sid\"><img src=\"../assets/img/gallery/featured1.png\"></a>
                    </div>
                    <div class=\"properties__caption\">
                        <p><a href=\"classroom.php?id=$gid&sid=$sid\">".$row[1]."</a></p>
